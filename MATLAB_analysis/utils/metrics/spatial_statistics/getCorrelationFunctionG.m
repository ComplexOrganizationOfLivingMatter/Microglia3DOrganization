...
% MATLAB image order unless the argument name explicitly states XYZ.
    ...
    savePath1 = fullfile(savePath, 'Graph', 'RadialDistributionFunction_G', typeSphere);
    savePathVariable = fullfile(savePath, 'Variables', 'RadialDistributionFunction_G', typeSphere);
