...
% MATLAB image order unless the argument name explicitly states XYZ.
    ...
    savePath1 = fullfile(savePath, 'Graph', 'RadialDistribution', 'AcumulativeDistribution', typeSphere);
    savePath2 = fullfile(savePath, 'Graph', 'RadialDistribution', 'Histogram', typeSphere);
    savePathVariable = fullfile(savePath, 'Variables', 'RadialDistribution', typeSphere);
